...
// --- NEW: Disable Right Click ---
document.addEventListener('contextmenu', event => event.preventDefault());

// --- NEW: Whitespace Trim & Auto-Capitalize ---
...
function validateLogin() {
    const enteredCode = loginInput.value.trim().toUpperCase();
    
    if (enteredCode === SITE_PASSCODE) {
